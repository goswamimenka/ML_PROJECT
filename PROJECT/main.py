...
def index():
    ...
    zip_code = sorted(data['zip_code'].unique())

    return render_template('index.html', bedrooms=bedrooms, bathrooms=bathrooms, sizes=sizes,zip_code=zip_code)
...
def predict():
    ...
    #handling unknown categories in the input data
